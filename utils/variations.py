...
BASIC_DICE_OUTCOMES = {
    "natural_fail": {
        ...
        "descriptions": ["Quel fiasco !", "Catastrophique...", "Un désastre total !", "Même en essayant, c'était perdu d'avance."],
        "status": "Échec naturel",
    },
    "critical_fail": {
        "color": discord.Color.dark_gray(),
        "descriptions": ["Le bonus n'a rien changé.", "Les dés donnent, le modificateur reprend.", "Raté malgré tout.", "La chance a ses limites."],
        "status": "Échec critique",
    },
    "bad": {
        "color": discord.Color.orange(),
        "descriptions": ["Pas brillant.", "Ça aurait pu être mieux.", "Les dés ne t'ont pas gâté.", "Un jet en dessous des attentes."],
        "status": "Mauvais résultat",
    },
    "normal": {
        "color": discord.Color.blurple(),
        "descriptions": ["Pas mal.", "Ça passe.", "Dans la moyenne.", "Ni brillant, ni catastrophique."],
        "status": "Résultat normal",
    },
    "good": {
        "color": discord.Color.teal(),
        "descriptions": ["Solide.", "Pas mal du tout.", "Un bon jet.", "La fortune sourit."],
        "status": "Bon résultat",
    },
    "natural_success": {
        "color": discord.Color.gold(),
        "descriptions": ["Parfait !", "Exactement ce qu'il fallait !", "Aucune marge d'erreur !", "Les dieux ont voté."],
        "status": "Succès naturel",
    },
    "critical_success": {
        "color": discord.Color.green(),
        "descriptions": ["Quelle dextérité !", "Magistral !", "Absolument parfait !", "Le bonus a tout changé."],
...
STAT_DICE_OUTCOMES = {
    "attaque": {
        ...
        "bad":              ["Le coup manque de conviction.", "Une attaque hésitante {de_character}.", "{character} attaque, sans y mettre toute sa puissance."],
        "normal":           ["Frappe correcte de la part {de_character}.", "{character} atteint sa cible.", "Un coup propre, sans éclat pour {character}."],
        "good":             ["Une frappe propre {de_character}.", "{character} place un coup solide.", "L'attaque {de_character} porte correctement."],
    ...
    "force": {
        ...
        "bad":              ["Un effort en deçà des capacités {de_character}.", "La puissance {de_character} n'est pas au rendez-vous.", "{character} peine à fournir l'effort requis."],
        "normal":           ["Effort solide {de_character}.", "La puissance {de_character} est au rendez-vous.", "Un résultat dans la norme pour {character}."],
        "good":             ["Une bonne démonstration de force {de_character}.", "La puissance {de_character} est là.", "{character} s'impose physiquement."],
    ...
    "défense": {
        ...
        "bad":              ["Une défense fragile {de_character}.", "{character} s'en sort, mais de justesse.", "La protection {de_character} laisse à désirer."],
        "normal":           ["Défense correcte {de_character}.", "{character} absorbe le coup.", "La protection {de_character} fait son travail."],
        "good":             ["Une bonne défense {de_character}.", "{character} tient bien sa garde.", "La protection {de_character} est solide."],
    ...
    "résistance": {
        ...
        "bad":              ["Le corps {de_character} résiste... à peine.", "{character} encaisse difficilement.", "Une résistance en dessous de la moyenne pour {character}."],
        "normal":           ["{character} encaisse.", "Le corps {de_character} tient bon.", "Une endurance dans la moyenne pour {character}."],
        "good":             ["Le corps {de_character} tient bon avec aisance.", "{character} encaisse sans sourciller.", "Une bonne endurance {de_character}."],
    ...
    "agilité": {
        ...
        "bad":              ["Un mouvement trop lent {de_character}.", "L'agilité {de_character} n'est pas à son maximum.", "{character} peine à coordonner ses mouvements."],
        ...
        "good":             ["Un déplacement fluide {de_character}.", "{character} se déplace avec aisance.", "L'agilité {de_character} est bien au rendez-vous."],
    ...
    "discrétion": {
        ...
        "bad":              ["Une discrétion approximative {de_character}.", "{character} n'est pas tout à fait invisible.", "Des traces laissées par {character} — mais peu."],
        ...
        "good":             ["Une bonne discrétion {de_character}.", "{character} passe presque inaperçu·e.", "Peu remarqué·e, {character} progresse en silence."],
    ...
    "perception": {
        ...
        "bad":              ["Un regard distrait {de_character}.", "{character} perçoit l'essentiel, mais pas les détails.", "Une lecture incomplète de la situation pour {character}."],
        ...
        "good":             ["Un bon sens de l'observation {de_character}.", "{character} remarque des détails importants.", "L'œil {de_character} est bien affûté."],
    ...
    "infiltration": {
        ...
        "bad":              ["L'infiltration {de_character} manque de fluidité.", "{character} avance, mais pas sans risque.", "Un passage discutable {de_character} — ça passe, mais de peu."],
        ...
        "good":             ["Une infiltration propre {de_character}.", "{character} navigue avec aisance.", "Un passage silencieux {de_character}."],
    ...
    "charisme": {
        ...
        "bad":              ["Les mots {de_character} manquent de conviction.", "Une présence en demi-teinte {de_character}.", "{character} s'exprime, mais sans vraiment convaincre."],
        "normal":           ["{character} s'exprime avec aisance.", "Les mots {de_character} trouvent leur cible.", "Une présence correcte pour {character}."],
        "good":             ["Une bonne présence {de_character}.", "{character} sait se faire entendre.", "Les mots {de_character} portent."],
